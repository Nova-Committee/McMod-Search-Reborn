...
public class CoreService {
    ...
    public static boolean openMcMod(ItemStack stack) {
        ...
        try {
            ...
            modName = URLEncoder.encode(Registry.ITEM.getKey(stack.getItem()).getNamespace(), StandardCharsets.UTF_8);
            regName = URLEncoder.encode(Registry.ITEM.getKey(stack.getItem()).toString(), StandardCharsets.UTF_8);
